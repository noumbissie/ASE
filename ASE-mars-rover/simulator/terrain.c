/* Terrain GL model loader taken from http://www.lighthouse3d.com/opengl/
   Copyright (C) 2001 António Ramires Fernandes <antonio.ramires@lighthouse3d.com>
*/
...
int terrainWidth(void) {
	return terrainGridWidth;
}
int terrainLength(void) {
	return terrainGridLength;
}
